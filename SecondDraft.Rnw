...
# Read the CSV file
my_data <- read.csv("/Users/lavanyasaxena/Downloads/daily_44201_2016-final.csv")
...
boxplot(my_data$Arithmetic.Mean,
        main = "Boxplot of Arithmetic Mean (United States)",
        ylab = "Value")
...
boxplot(my_data$AQI,
        main = "Boxplot of AQI (United States)",
        ylab = "Value")
...
<<echo=FALSE>>=
emissions <- read.csv("/Users/lavanyasaxena/Downloads/daily_44201_2016-final.csv")
